...
class ConsoleSenderUnitTest {
    ...
    class SendToTargetChannel {
        ...
        @Test
        void when_sendToTargetChannel_then_returnSuccess() {
            String otp = "123456";
    ...
    class GetChannel {
        ...
        @Test
        void when_getChannel_then_returnConsole() {
            SendingChannel channel = consoleSender.getChannel();

            assertEquals(SendingChannel.CONSOLE, channel);
        }
    }
}
